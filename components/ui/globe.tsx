...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  }, [data, defaultProps.arcLength, defaultProps.arcTime, defaultProps.atmosphereAltitude, defaultProps.atmosphereColor, defaultProps.maxRings, defaultProps.polygonColor, defaultProps.rings, defaultProps.showAtmosphere, globeData]);
