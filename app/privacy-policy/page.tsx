    ...
    <main className="container mx-auto px-4 py-12">
      ...
      >
        ...
        <motion.p className="text-xl mb-8 text-muted-foreground max-w-3xl mx-auto" variants={itemVariants}>
          At RemitCache, we are committed to protecting your privacy and ensuring the security of your personal information.
            ...
            <Accordion type="single" collapsible className="w-full">
              {policyItems.map((item, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="border-zinc-700">
                  <AccordionTrigger className="text-left text-muted-foreground hover:text-foreground">{item.title}</AccordionTrigger>
